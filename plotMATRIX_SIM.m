function plotMATRIX_SIM(DADOS_AREA,DADOS_STD)
...
clim = [-100 100];
matplot_revista_sim(DADOS_AREA,clim,['D1a';'D1b';'D1c';'D2a';'D2b';'D2c';'D3a';'D3b';'D3c';'D4a';'D4b';'D4c']',['FD       ';'Scott    ';'Sturges  ';'Doane    ';'Knuth    ';'Wand     ';'Shimazaki';'Rudemo   ';'LHM      ';'Bin*     ']', '\DeltaBins')
hold on
