...
function aboxplot_var(X,varargin)
       ...
       if j==16
        ...
        if q3 > q1
            rectangle('Position',[i-widthl/2+(2*j-1-widths)*widthl/(2*d) q1 widths*widthl/d q3-q1],...
                'EdgeColor',ce,'FaceColor',fc,'HitTest','off','Parent',hgg(j));
        end
        ...
        %                     'Color','k','LineWidth',1,'HitTest','off','Parent',hgg(j));hold on
        mk = 's';
        mc = [0,0,0];
        ...
        if (i==1) || (i==2) || (i==3) || (i==4) || (i==5) || (i==6) || (i==7) || (i==8) || (i==9) || (i==10) || (i==11) || (i==12) || (i==13) || (i==14) || (i==15) || (i==16)
            if (j == d)
                ...
                plot([vx+0.175*widthl vx+0.175*widthl],[min(min(minY)) max(max(maxY))*1.5],':','Color',[0.85 0.85 0.85],'Linewidth',2)
            end
        end
