...
for d = dn
    ...
    %   pause
    saveas(gcf,[pwd '\' method '\' method '[AREA]DIST[' name_true{dt} '][ROBUST]'],'fig');
    saveas(gcf,[pwd '\' method '\' method '[AREA]DIST[' name_true{dt} '][ROBUST]'],'png');
    close
    ...
    set(gca,'LooseInset',get(gca,'TightInset'))
    %   pause
    saveas(gcf,[pwd '\' method '\' method '[H]DIST[' name_true{dt} '][ROBUST]'],'fig');
    saveas(gcf,[pwd '\' method '\' method '[H]DIST[' name_true{dt} '][ROBUST]'],'png');
    close
end