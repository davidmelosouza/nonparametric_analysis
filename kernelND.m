function [X,f] = kernelND(DATA,nPoint,est,bin,h,hfix,type,dolambda)
...
% dolambda = 1;
% h = h.PI.SJ
[~,hi,X,H] = PILOT(DATA,nPoint,est,bin,h,hfix,type,dolambda);
%==========================================================================
...
switch type
    case 'fix'
        [X,f] = KDEfast_fixed(x,H,nPoint);
    case 'SSE'
        [X,f] = KDESSE(x,{hi},nPoint,h);
    case 'BE'
